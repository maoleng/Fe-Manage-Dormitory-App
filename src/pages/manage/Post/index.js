  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', flexDirection: 'row' }} >
        ...
        >
          <div>
            <button onClick={() => setShowCreatePost(true)}>Thêm bài viết</button>
          </div>
          ...
          {posts === null ? (
            ...
            <>
              <MyTable 
                forms={posts.map(({ id, title, teacher_name, created_at, updated_at, category, tags }) => ({
                  id: {
                    title: 'ID',
                    content: '' + id
                  },
      ...
      <Modal size="lg" show={showCreatePost} onHide={() => setShowCreatePost(false)}>
        ...
        <Modal.Body style={{ padding: '80px' }}>
          ...
          >
            ...
            >
              <Link style={{ color: '#000000', textDecoration: 'none' }} to='/quan-ly/bai-dang/tao-them'>
                <div>
                  <img style={{ width: '100px' }} src="/imgs/site/create-post-1.png" alt=""/>
                </div>
                <div style={{ width: '100%', height: '20px'}}></div>
                Tạo bài viết
              </Link>
            ...
            >
              <Link style={{ color: '#000000', textDecoration: 'none' }} to='#'>
                <div>
                  <img style={{ width: '100px' }} src="/imgs/site/create-post-2.png" alt=""/>
                </div>
                <div style={{ width: '100%', height: '20px'}}></div>
                tải lên từ file
              </Link>
