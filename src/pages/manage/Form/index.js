                    ...
                    content: (
                      <>
                        <button
                          ...
                          onClick={() => {getFormHandle(id); setShowCommentForm(true)}}
                        >
                          <svg
                    ...
                    <div>
                      <div style={{ width: '100%' }}>
                        {imgComments.map((source, index) => (
                          <div style={{ width: '100px', height: '100px', position: 'relative', display: 'inline-block'}} key={index}>
                            <img style={{ height: '100px', width: '100px', objectFit: 'contain', objectPosition: 'center' }} src={source} alt={index} key={index}/>
                            <svg style={{ width: '16px', height: '16px', position: 'absolute', top: '4px', right: '4px', cursor: 'pointer' }} onClick={() => removeImgComment(index)} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
